...
//                         '                                                                           id="editEmployeePhone" placeholder="Phone number" required>\n' +
//                         '                </div>\n' +
//                         '    \n' +
//                         '                <div class="form-group">\n' +
//                         '                    <label for="editEmployeeEmail">Email</label> <input type="email"\n' +
//                         '                                                                    value="{{dataItem.email}}" class="form-control" ng-model-options="{updateOn:\'kepress\'}"\n' +
//                         '                                                                    id="editEmployeeEmail" ng-model="dataItem.email" placeholder="Email" required>\n' +
//                         '                </div>\n' +
//                         '    \n' +
//                         '                <button type="submit" class="btn btn-default">Submit</button>\n' +
...
//     }
    ...
    $scope.templateUrl =function (){
        switch (getOnChange) {
            case 'employee':
            {
                return "web/employee/employee.html";
                break;
            }
            case 'account':
            {
                return "web/account/account.html";
                break;
            }
        }
    }
